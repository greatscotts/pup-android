...
public class Nation extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    Button q = (Button) findViewById(R.id.button2);
	     q.setOnClickListener(new View.OnClickListener() {
	        ...
	        Intent i = new Intent(Nation.this,Info.class);
	        startActivity(i);
	        finish();
	        } 
	     });
	     ...
	     b.setOnClickListener(new View.OnClickListener() {
	        public void onClick(View arg0) {
	        Intent i = new Intent(Nation.this,Misc.class);
	        startActivity(i);
	        finish();
	        } 
	     });
	     ...
	     g.setOnClickListener(new View.OnClickListener() {
	        public void onClick(View arg0) {
	        Intent i = new Intent(Nation.this,Social.class);
	        startActivity(i);
	        finish();
	        } 
	     });
	     ...
	     z.setOnClickListener(new View.OnClickListener() {
	        public void onClick(View arg0) {
	        Intent i = new Intent(Nation.this,Logon.class);
	        startActivity(i);
	        finish();
	        } 
	     });
		...
		ourBrow.loadUrl("http://pupportalnews.wirenode.mobi/");
        ...
        webView.loadUrl("http://pupportalnews.wirenode.mobi/");
    }
