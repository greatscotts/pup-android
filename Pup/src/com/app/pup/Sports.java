	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    Button q = (Button) findViewById(R.id.button2);
	     q.setOnClickListener(new View.OnClickListener() {
	        ...
	        Intent i = new Intent(Sports.this,Info.class);
	        startActivity(i);
	        finish();
	        } 
	     });
	     ...
	     b.setOnClickListener(new View.OnClickListener() {
	        public void onClick(View arg0) {
	        Intent i = new Intent(Sports.this,Misc.class);
	        startActivity(i);
	        finish();
	        } 
	     });
	     ...
	     g.setOnClickListener(new View.OnClickListener() {
	        public void onClick(View arg0) {
	        Intent i = new Intent(Sports.this,Social.class);
	        startActivity(i);
	        finish();
	        } 
	     });
	     ...
	     z.setOnClickListener(new View.OnClickListener() {
	        public void onClick(View arg0) {
	        Intent i = new Intent(Sports.this,Logon.class);
	        startActivity(i);
	        finish();
	        } 
	     });
		...
		ourBrow.loadUrl("http://pupportalsports.wirenode.mobi");
        ...
        webView.loadUrl("http://pupportalsports.wirenode.mobi");
    }
